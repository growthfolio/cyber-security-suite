...
import com.codexraziel.cybersec.controllers.BruteForceController;
...
public class BruteForceView {
    ...
    public VBox createView(Label statusLabel) {
        ...
        Button startBfBtn = new Button("Start Brute Force");
        startBfBtn.setGraphic(CodexIcons.START);
        Button stopBfBtn = new Button("Stop Attack");
        stopBfBtn.setGraphic(CodexIcons.STOP);
        Button previewBtn = new Button("Preview Combinations");
        previewBtn.setGraphic(CodexIcons.SEARCH);
        Button calculateBtn = new Button("Calculate Total");
        calculateBtn.setGraphic(CodexIcons.PERFORMANCE);
        ...
        targetLabel.setGraphic(CodexIcons.WIFI);
        Label passwordLabel = new Label("Password Generation:");
        passwordLabel.setGraphic(CodexIcons.TOOLS);
        Label attackControlsLabel = new Label("Attack Controls:");
        attackControlsLabel.setGraphic(CodexIcons.BRUTEFORCE);
        Label statsLabel = new Label("Real-time Statistics:");
        statsLabel.setGraphic(CodexIcons.PERFORMANCE);
