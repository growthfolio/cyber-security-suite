...
public class WiFiNetwork {
    ...
    public enum NetworkStatus {
        SECURE("GREEN", "Secure", "-fx-text-fill: green;"),
        SUSPICIOUS("YELLOW", "Suspicious", "-fx-text-fill: orange;"),
        VULNERABLE("RED", "Vulnerable", "-fx-text-fill: red;"),
        SCANNING("SATELLITE", "Scanning", "-fx-text-fill: blue;"),
        UNKNOWN("WHITE", "Unknown", "-fx-text-fill: gray;");
